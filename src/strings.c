...
const u8 gText_Physical[] = _(" {PALETTE 1}(P)");
const u8 gText_Special[] = _(" {PALETTE 1}(S)");
const u8 gText_Status[] = _(" {PALETTE 1}(T)");
...
const u8 gText_MoveItem[] = _("MOVE");
const u8 gText_MoveItemToWhere[] = _("Move item to which POKéMON?");
const u8 gText_MovedItemToMon[] = _("Moved the {STR_VAR_2} from\n{STR_VAR_1} to {STR_VAR_3}.{PAUSE_UNTIL_PRESS}");
const u8 gText_SwappedItemsBetweenMons[] = _("Swapped {STR_VAR_1}'s and\n{STR_VAR_3}'s held items.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokeSum_PageName_EvIvCheck[] = _("IV/EV CHECK");
...
const u8 gText_DayNight[] = _("DAY/NIGHT");
