...
extern const u8 gText_MoveItemToWhere[];
extern const u8 gText_MovedItemToMon[];
extern const u8 gText_SwappedItemsBetweenMons[];
...
extern const u8 gText_DayNight[];
...
extern const u8 gText_PokeSum_PageName_EvIvCheck[];
